...
**Tasks accomplished:** Experimented more with arrow functions today and read more about the ES6+ syntax.

**Thoughts on the same:** Looking forward to diving deeper into ES6+!

**Link to my work:** [My exploration](https://github.com/theRangeCoder/JavaScript-exploration/blob/main/script3.js)

### Day 79: Sunday, 1. August 2021

**Tasks accomplished:** Learnt about default parameters and the includes() function.

**Thoughts on the same:** The default parameters seemed quite interesting.

**Link to my work:** [My exploration](https://github.com/theRangeCoder/JavaScript-exploration/blob/main/script3.js)

### Day 80: Monday, 2. August 2021

**Tasks accomplished:** Learnt the difference among the var, let and const keywords (variable hoisting and modifications). Also learnt about the export and import keywords.

**Thoughts on the same:** The export and import keywords seem like the perfect solution for making the code, more modular.

**Link to my work:** [My exploration](https://github.com/theRangeCoder/JavaScript-exploration/blob/main/script3.js)

### Day 81: Tuesday, 3. August 2021

**Tasks accomplished:** Played around with the padStart() and padEnd() string methods today.

**Thoughts on the same:** Would love to research more about the utility of the above two methods for real-life problems.

**Link to my work:** [My exploration](https://github.com/theRangeCoder/JavaScript-exploration/blob/main/script3.js)

### Day 82: Wednesday, 4. August 2021

**Tasks accomplished:** Explored a bit of classes today.

**Thoughts on the same:** Classes seem interesting. Looking forward to exploring more of it, tomorrow.

**Link to my work:** [My exploration](https://github.com/theRangeCoder/JavaScript-exploration/blob/main/script3.js)

### Day 83: Thursday, 5. August 2021

**Tasks accomplished:** Learnt about classes, objects and inheritance today. Also learnt about static functions and the 'get' keyword to define object properties.

**Thoughts on the same:** Today's learning was an incredible one. Feels powerful to know something about object-oriented programming.

**Link to my work:** [My exploration](https://github.com/theRangeCoder/JavaScript-exploration/blob/main/script3.js)

### Day 84: Friday, 6. August 2021

**Tasks accomplished:** Learnt about the initial concepts of asynchronous JavaScript *viz.* callbacks and asynchronous functions.

**Thoughts on the same:** It was fairly hard for me to get a good grasp of callbacks today. I will certainly revisit it tomorrow.

**Link to my work:** [My exploration](https://github.com/theRangeCoder/JavaScript-exploration/blob/main/script3.js)

### Day 85: Saturday, 7. August 2021

**Tasks accomplished:** Explored asynchronous programming, callbacks and promises in much more depth today.

**Thoughts on the same:** Loved the idea of asynchronous programming. It is quite useful for the processing of multiple tasks simultaneously.

**Link to my work:** [My exploration](https://github.com/theRangeCoder/JavaScript-exploration/blob/main/script3.js)

### Day 86: Sunday, 8. August 2021

**Tasks accomplished:** Read further on promises and experimented with it as well.

**Thoughts on the same:** Looking forward to learning more concepts of asynchronous programming tomorrow.

**Link to my work:** [My exploration](https://github.com/theRangeCoder/JavaScript-exploration/blob/main/script3.js)

### Day 87: Tuesday, 10. August 2021

**Tasks accomplished:** Learnt about sets in JavaScript and experimented with some methods of the Set class. Finished the ES6+ course today.

**Thoughts on the same:** Sets are indeed a nice way to store unique values!

**Link to my work:** [My exploration](https://github.com/theRangeCoder/JavaScript-exploration/blob/main/script3.js)

### Day 88: Wednesday, 11. August 2021

**Tasks accomplished:** Solved my third HackerRank challenge today and earned my first badge (The Bronze Badge for Problem Solving) today.

**Thoughts on the same:** It was quite encouraging to have earned my first badge on HackerRank today. Looking forward to solving many more challenges in the days to come.

**Link to my solution:** [My solution](https://github.com/theRangeCoder/HackerRank-Interview-Prep/blob/main/Warm-up%20Challenges/jumping_on_the_clouds.js)

### Day 89: Thursday, 12. August 2021

**Tasks accomplished:** Watched some videos related to the React.js library and started working on a HackerRank problem.

**Thoughts on the same:** React.js seems to be fun. Looking forward to diving deeper into it very soon.

### Day 90: Friday, 13. August 2021

**Tasks accomplished:** Solved the Repeated Strings problem on HackerRank today.

**Thoughts on the same:** The solution wasn't really the most optimised one, but I hope to do better, the next time.

**Link to my solution:** [My solution](https://github.com/theRangeCoder/HackerRank-Interview-Prep/blob/main/Warm-up%20Challenges/repeated_string.js)

### Day 91: Sunday, 15. August 2021

**Tasks accomplished:** Solved the Equalize the Array problem on HackerRank today.

**Thoughts on the same:** I was happy with my solution to the problem, however would love to evaluate it for further improvements.

**Link to my solution:** [My solution](https://github.com/theRangeCoder/HackerRank-Interview-Prep/blob/main/Algorithms/equalize_the_array.js)

### Day 92: Tuesday, 17. August 2021

**Tasks accomplished:** Learnt about how JavaScript works as well as started off my journey with React.js today.

**Thoughts on the same:** Looking forward to diving deeper into React in the days to come.

### Day 93: Wednesday, 18. August 2021

**Tasks accomplished:** Explored and played around with JSX as well as learnt about class and functional components.

**Thoughts on the same:** It was fun to install npm as well as the required dependencies for React to run. Looking forward to exploring React to the core.

**Link to my exploration:** [My exploration](https://github.com/theRangeCoder/react-exploration)

### Day 94: Thursday, 19. August 2021

**Tasks accomplished:** Revisited components as well as got introduced to props today.

**Thoughts on the same:** React seems to be getting a bit complicated but I've got this!

**Link to my exploration:** [My exploration](https://github.com/theRangeCoder/react-exploration/tree/main/components)

### Day 95: Saturday, 21. August 2021

**Tasks accomplished:** Explored props in React today.

**Thoughts on the same:** Looking forward to experimenting with props further, as well as exploring state.

**Link to my exploration:** [My exploration](https://github.com/theRangeCoder/react-exploration/tree/main/components)

### Day 96: Sunday, 22. August 2021

**Tasks accomplished:** Explored states of components as well as played around with props today.

**Thoughts on the same:** The virtual DOM was quite interesting to know about. Loved the way how React deals with state changes through the virtual DOM.

**Link to my exploration:** [My exploration](https://github.com/theRangeCoder/react-exploration/tree/main/components)

### Day 97: Monday, 23. August 2021

**Tasks accomplished:** Used the map method for arrays, to make the user detail rendering as well as state change more dynamic.

**Thoughts on the same:** It was nice to have gotten a clearer picture of states and props today. Looking forward to creating stronger connections among the React concepts with time.

**Link to my exploration:** [My exploration](https://github.com/theRangeCoder/react-exploration/tree/main/components)

### Day 98: Thursday, 26. August 2021

**Tasks accomplished:** Learnt about events and two-way data binding in React today.

**Thoughts on the same:** It feels nice to get deeper into React. Looking forward to learning more, tomorrow.

**Link to my work:** [My work](https://github.com/theRangeCoder/react-exploration/tree/main/two-way-binding)

### Day 99: Saturday, 28. August 2021

**Tasks accomplished:** Finally took some time out, to write detailed documentation on the Lead Tracker project that I had done, a while ago. Also explored some React today.

**Thoughts on the same:** The project looks much more complete after having written the documentation for it. Happy to have done that today.

**Link to the project:** [My project](https://github.com/theRangeCoder/lead-tracker-chrome-extension)

### Day 100: Sunday, 29. August 2021

**Tasks accomplished:** Started working on the Tesla clone today. Also, today was the last day for the first round of the #100DaysOfCode challenge.

**Thoughts on the same:** It has been quite a joyride, to have taken this challenge. Lots of learning. Time to process the experience now, before I can start with another round of it.
